    ...
    <>
      ...
      <div
        ...
        <div className="space-y-8">
          ...
          {/* معاون فنی */}
          <div className="bg-white p-5 rounded-lg shadow-sm border border-gray-200">
            <h2 className="font-semibold text-lg text-yellow-700 mb-2 flex items-center gap-2">
          ...
          {/* حساب بانکی مدرسه */}
          <div className="bg-white p-5 rounded-lg shadow-sm border border-gray-200">
            <h2 className="font-semibold text-lg text-teal-700 mb-2 flex items-center gap-2">
